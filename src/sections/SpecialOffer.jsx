    ...
    ">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-4 lg:max-w-lg info-text">
          ...
          deals. From premier selections to incredible savings, we offer uparalleled
          value that sets us appart.
        </p>
        <p className="mt-6 lg:max-w-lg info-text">
          Navigate a realm of possibilities designed to fullfil your unique desires,
